...
> [!NOTE]
> Detailed guidelines, component treatments, design system tokens, responsive behaviors, accessibility standards, and edge cases are located in [.agents/references/templates/product-spec-instructions.md](../references/templates/product-spec-instructions.md). Refer to that document when generating specs.

## Output format
Generate both `product-spec.md` (this template) and `product-spec.html` (copy content to `.agents/templates/product-spec-template.html`).
