...
**Change log:**
- v4: Added Research Foundation §2; renumbered all subsequent sections
...
|----------|------|--------|--------------------------|
| Idea Brief | `artifacts/output/00-discovery/idea-brief.md` | [ ] Reviewed / [PENDING] | ... |
| Validation Brief | `artifacts/output/00-discovery/validation-brief.md` | [ ] Reviewed / [PENDING] | ... |
| Market Analysis | `artifacts/output/01-research/market-analysis.md` | [ ] Reviewed / [PENDING] | ... |
| Competitive Analysis | `artifacts/output/01-research/competitive-analysis.md` | [ ] Reviewed / [PENDING] | ... |
| User Personas | `artifacts/output/01-research/user-personas.md` | [ ] Reviewed / [PENDING] | ... |
| UX Research Report | `artifacts/output/01-research/ux/ux-research-report.md` | [ ] Reviewed / [PENDING] | ... |
...
> **Framework reference:** See `.opencode/references/release-planning-frameworks.md` for all options (MoSCoW, RICE, Kano, Now/Next/Later, Value vs. Effort, WSJF) and when to use each.
...
- Supersedes: v2.0 (added Hypothesis of Solution §3)