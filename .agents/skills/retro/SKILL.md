...
**Output:** `artifacts/output/09-retro/data-collection.md` (Use template: `.agents/templates/retrospective-template.md`)
...
**Output:** `artifacts/output/09-retro/execution-review.md` (Use template: `.agents/templates/retrospective-template.md`)
...
**Output:** `artifacts/output/09-retro/process-review.md` (Use template: `.agents/templates/retrospective-template.md`)
...
**Output:** `artifacts/output/09-retro/product-review.md` (Use template: `.agents/templates/retrospective-template.md`)
...
**Output:** `artifacts/output/09-retro/architecture-review.md` (Use template: `.agents/templates/retrospective-template.md`)
...
**Output:** `artifacts/output/09-retro/action-items.md` (Use template: `.agents/templates/retrospective-template.md`)
...
```bash
node .agents/scripts/orchestrator_state.js complete --agent product-manager --artifact 09-retro/data-collection.md
node .agents/scripts/orchestrator_state.js complete --agent tech-lead --artifact 09-retro/execution-review.md
node .agents/scripts/orchestrator_state.js complete --agent product-manager --artifact 09-retro/process-review.md
node .agents/scripts/orchestrator_state.js complete --agent product-manager --artifact 09-retro/product-review.md
node .agents/scripts/orchestrator_state.js complete --agent architect --artifact 09-retro/architecture-review.md
```
