...
**Output:** `artifacts/output/06-launch/release-readiness.md` (Use template: `.agents/templates/release-readiness-template.md`)
...
**Output:** `artifacts/output/06-launch/go-nogo-decision.md` (Use template: `.agents/templates/go-nogo-decision-template.md`)
...
**Output:** Deployment runbook (in launch-log), release notes (Use template: `.agents/templates/release-notes-template.md`), migration guides
...
**Output:** `artifacts/output/06-launch/launch-log.md` (Use template: `.agents/templates/launch-log-template.md`)
...
**Output:** `artifacts/output/06-launch/post-launch-report.md` (Use template: `.agents/templates/post-launch-report-template.md`)
