...
Read `artifacts/output/teaching/knowledge-map.md`. Extract core syntax, formulas, decision rules, and key term mappings.
...
## Memory closeout
- `@memory-controller session-write` — record cheatsheet completion milestone.
