...
Read `artifacts/output/teaching/knowledge-map.md`. Load target explanation style (`Beginner`, `Intermediate`, or `Expert`).
...
## Memory closeout
- `@memory-controller session-write` — record handbook completion milestone.
