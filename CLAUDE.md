...
> Depending on your active AI assistant harness, the base configuration directory (originally via harness-specific naming) should be renamed or adapted to your harness's expected dotfolder. Throughout this document, we refer to this base folder as `.agents`. Common names include:
> - **Kiro**: `.kiro/`
