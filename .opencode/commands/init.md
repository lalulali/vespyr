...
- **System Directive Prompt Pattern**:
  ...
  Strictly adhere to the 4 Core Behavioral Guidelines (Think Before Acting, Simplicity First, Surgical Actions, Goal-Driven Execution) defined in AGENTS.md / agent.md.
